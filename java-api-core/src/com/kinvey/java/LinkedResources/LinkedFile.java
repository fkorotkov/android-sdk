...
/**
 * This class maintains metadata and java specific file access to a NetworkFileManager associated with an Entity through the {@code com.kinvey.java.network.LinkedNetworkManager} API.
 *
