 ...
 */
public final class Retrieve<T extends com.kinvey.java.dto.User> extends AbstractKinveyJsonClientRequest<T> {
    ...
    public Retrieve(User user, String userID, Class<T> myClass) {
    ...
    public Retrieve(User user, Query query, Class<T> myClass){
        super(user.getClient(), "GET", REST_PATH, null, myClass);
        this.user = user;
    ...
    public Retrieve(User user, String userID, String[] resolve, int resolve_depth, boolean retain, Class<T> myClass){
        super(user.getClient(), "GET", REST_PATH, null, myClass);
        this.user = user;
        this.userID = userID;
    ...
    public Retrieve(User user, Query query, String[] resolve, int resolve_depth, boolean retain, Class<T> myClass){
        super(user.getClient(), "GET", REST_PATH, null, myClass);
        this.user = user;
        this.queryFilter = query.getQueryFilterJson(user.getClient().getJsonFactory());
        int queryLimit = query.getLimit();
