...
public class GCMPush extends AbstractPush {
    ...
    public GCMPush initialize(final Application currentApp) {
        if (!getClient().getUserInstance().isUserLoggedIn()){
...
//                	ex.printStackTrace();
        ...
        if (register) {
            ...
            client.push().enablePushViaRest(new KinveyClientCallback() {
                ...
                public void onSuccess(Object result) {
                	client.getUserInstance().retrieve(new KinveyUserCallback() {
						
						@Override
						public void onSuccess(User result) {
							client.getUserInstance().put("_messaging", result.get("_messaging"));
    ...
    public boolean isPushEnabled() {
        ...
        if (getClient().getUserInstance().containsKey("_messaging")){
            AbstractMap<String, Object> pushField = (AbstractMap<String, Object>) getClient().getUserInstance().get("_messaging");
